    ...
    <div v-if="visible" class="image-preview-mask" @click.self="handleClose">
      <div class="image-preview-container">
        <div class="preview-header">
          ...
          <span class="preview-index">{{ currentIndex + 1 }} / {{ images.length }}</span>
          <el-icon class="close-btn" @click="handleClose"><Close /></el-icon>
        </div>

        <div class="preview-main">
          <div class="preview-toolbar left" @click="handlePrev">
          ...
          <div class="preview-toolbar right" @click="handleNext">
