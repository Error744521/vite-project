<template>
  <div class="index-content-page">
    <div class="module_page">
      <searchModule :showArray="state.showArray" @setCallback="getList"></searchModule>
...
const state = reactive({
  showArray: [
    ...
    { label: '筛选信息', array: { org_id: true, target_type: true, area_ids: true, create_at: true, time_period: true } },
    {
      label: '数据条件',
      array: {
        inclusion_mode: true,
