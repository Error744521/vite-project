const ObjectForm = {
  ...
  platform_id: { component: 'selectForm', type: 'string', label: '平台名称', key: 'platform_id', list: [],
    request: { url: '/v1/platforms/list', method: 'post', param: { platform_type: 3 }, label: 'platform_name', value: 'id' }
  },
  takeout_category_id: { component: 'selectForm', type: 'Array', label: '平台名称', key: 'takeout_category_id', list: [],
  ...
  flag: { component: 'selectForm', type: 'string', label: '店铺类型', key: 'flag',
    list: [{ label: '全部', value: '' }, { label: '交易网站', value: '3' }, { label: '非交易网站', value: '1' }]
  },
  category_id: { component: 'groupSelectForm', type: ['string', 'string'], label: '店铺分类', key: 'category_id', list: [],
  ...
  is_trade: { component: 'groupRadioForm', type: 'radio', label: '经营性质', key: 'is_trade', request: {},
    list: [{ label: '全部', value: '' }, { label: '非交易', value: '0' }, { label: '交易', value: '1' }]
  },
  monitor_frequency_flag: { component: 'groupRadioForm', type: 'button', label: '监测频率', key: 'monitor_frequency_flag', list: [],
    request: { url: '/v1/takeouts/catelist', method: 'post', param: { cate_id: 0 }, label: 'takeout_cate_name', value: 'id' }
  },
  ...
  behavior_id: { component: 'cascaderForm', type: 'string', label: '违法行为', key: 'behavior_id', list: [],
  ...
  label_id: { component: 'autocompleteForm', type: 'string', label: '数据标签', key: 'label_id', list: [],
    request: { url: '/v1/labels/list', method: 'post', param: { target_type: 3 }, label: 'label_name', value: 'id' }
  },
  file_path: { component: 'uploadFileForm', type: 'string', label: '文件上传', key: 'file_path', list: [],
    accept: '.xls,.xlsx', text: '文件上传', tip: true, limit: 1,
    request: { url: '/v1/companies/company_import', method: 'post', param: {} }
  },
  image_path: { component: 'uploadPictureForm', type: 'string', label: '图片上传', key: 'image_path', list: [],
