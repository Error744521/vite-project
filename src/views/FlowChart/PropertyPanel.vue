  ...
  <div class="diagram-panel">
    <div class="setting-block">
      ...
      <div class="short-styles">
        <div v-for="(item, index) in shortStyles" :key="index" :style="{ 'backgroundColor': item.backgroundColor, 'borderColor': item.borderColor, 'borderWidth': item.borderWidth }" @click="setStyle(item)"></div>
      </div>
    </div>
    <div class="setting-block">
      ...
      <div class="setting-item">
        <span>文本大小</span>
        <el-input-number v-model="style.fontSize" controls-position="right" size="mini" @change="$_changeFontSize" :min="12" :max="30"></el-input-number>
        <span>px</span>
      </div>
      <div class="setting-item">
        <span>文本字体</span>
      ...
      <div class="setting-item">
        ...
        <el-select v-model="style.lineHeight" size="small" @change="$_changeLineHeight">
          <el-option v-for="(item, index) in lineHeightOptions" :key="index" :label="`${item}`" :value="item"></el-option>
        </el-select>
      </div>
      <div class="setting-item">
        <span>对齐</span>
