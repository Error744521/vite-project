...
<div class="diagram">
  <div class="diagram-main">
    ...
    <div class="diagram-container" ref="container">
       <diagram-toolbar class="diagram-toolbar" v-if="lf" :lf="lf" :activeEdges="activeEdges" @changeNodeFillColor="$_changeNodeFill" @saveGraph="$_saveGraph"/>
  ...
  <!-- 右侧属性面板 -->
  <PropertyPanel class="diagram-panel" v-if="activeNodes.length>0 || activeEdges.length > 0" :onlyEdge="activeNodes.length === 0" :elementsStyle="properties" @setStyle="$_setStyle" @setZIndex="$_setZIndex"/>
</div>
</template>
...
import { registerCustomElement } from './index.js'
...
/*      getList().then(res => {
      ...
      // this.download(this.filename, JSON.stringify(data)) 下载txt文件
    },
